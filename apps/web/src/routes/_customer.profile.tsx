    ...
    <div className="mx-auto grid max-w-2xl gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Email and role cannot be changed here.</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-3 text-sm">
          ...
          <div>
            ...
            <p>
              <span className="inline-flex rounded-full border border-border bg-muted px-2 py-0.5 text-xs capitalize text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-4 sm:flex-row sm:items-center">
          <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-full border border-border bg-muted text-lg font-semibold text-muted-foreground">
            {user.avatarUrl ? (
