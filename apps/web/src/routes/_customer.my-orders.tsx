...
export default function MyOrdersPage() {
	...
	if (orders === undefined) {
		return <p className="text-muted-foreground text-sm">Memuat pesanan…</p>;
	}
	...
	return (
		<div className="flex flex-col gap-8">
			<div>
				<h1 className="font-semibold text-2xl tracking-tight">Pesananku</h1>
				<p className="text-muted-foreground text-sm">
					Status pesanan di meja kamu, diperbarui langsung.
				</p>
			</div>
