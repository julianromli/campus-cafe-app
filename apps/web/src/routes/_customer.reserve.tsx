...
export default function ReservePage() {
	...
	>(null);
	const [selectedTable, setSelectedTable] = useState<FloorPlanTable | null>(
		null,
	);
		...
		<>
			<div className="flex flex-col gap-6 pb-8 sm:gap-8">
				<div className="flex flex-col gap-1.5">
					<h1 className="font-bold font-heading text-4xl text-foreground tracking-tight">
						Reserve a Table
					</h1>
				...
				<div className="grid gap-6 lg:grid-cols-[1fr_280px]">
					<Card className="overflow-hidden rounded-[2rem] border border-border/50 bg-background/50 shadow-sm backdrop-blur-xl">
						<CardHeader className="border-border/50 border-b bg-muted/20 px-6 py-4">
					...
					<div className="flex flex-col gap-4">
						<Card className="rounded-[2rem] border border-primary/10 bg-primary/5 shadow-sm">
							...
							<CardContent className="flex flex-col gap-4 text-sm">
								...
								<div className="mt-2 rounded-xl bg-background p-4 text-muted-foreground text-xs leading-relaxed shadow-sm">
